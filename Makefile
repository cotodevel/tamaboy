...
#Custom
# Project Specific
export TGDSPROJECTNAME = ndstamaboy
...
ifeq ($(SOURCE_MAKEFILE9),default)
	...
	-@rm -fr $(EXECUTABLE_FNAME)	$(TGDSPROJECTNAME).srl	$(CURDIR)/common/templateCode/	$(DIR_ARM9)/data/arm7bootldr.binlzss	$(DIR_ARM9)/data/arm7bootldr_twl.binlzss
